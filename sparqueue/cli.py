...
def setup_parser(parser, subparsers, config, system, queue):
    ...
    traceback_parser = subparsers.add_parser(
        'traceback', help='retrieve job traceback')
